...
model_path="/apdcephfs_cq11_303410783/share_303410783/ziqiangcui/LLaMA-Factory/saves/llama3.2_3B/full/deepseek_distill_sft/tqa_lr5e5_epoch2_bs128"
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='llama_3b_rollout5_lr1e5_alldata_rw4' \
    ...
    custom_reward_function.name=compute_score_tqa_v4 \
