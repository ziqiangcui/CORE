...
model_path="/apdcephfs_cq11_303410783/share_303410783/ziqiangcui/LLaMA-Factory/saves/qwen2.5_1.5B/full/deepseek_distill_sft_llama_1b/nq_lr5e5_epoch2_bs128"
data_path="/apdcephfs_cq11_303410783/share_303410783/ziqiangcui/verl_new/data"

qa_train_path=$data_path/nq/train_sample_all.parquet
qa_test_path=$data_path/nq/eval_sample_500_v2.parquet
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python3 -m verl.trainer.main_ppo \
    ...
    trainer.experiment_name='llama_1b_rollout5_lr1e5_alldata_rw3_res64' \
    trainer.n_gpus_per_node=8 \
    trainer.nnodes=1 \
    trainer.save_freq=307 \
    trainer.test_freq=307 \
    ...
    custom_reward_function.name=compute_score_nq_v3 \
